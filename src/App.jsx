              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} id="platform-grid-container" className="platform-grid-wrapper">
                <div className="platform-grid">
                  <div className="platform-card card">
                    ...
                    <a href="https://drive.google.com/uc?export=download&id=1dLrqNmOq5up_EpQemVWMjLZijqQgVa9T" className="btn btn-md btn-gradient download-link" target="_blank" rel="noopener noreferrer">
